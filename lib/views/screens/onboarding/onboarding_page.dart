...
import 'package:fancai_client/views/screens/onboarding/onboarding_content.dart';
...
class _IntroPageState extends State<IntroPage>
  ...
  Widget _buildStack() {
    final content = OnboardingContent(page: widget.page, isFullScreen: true);
            ...
            child: Align(
              ...
              child: widget.page.useScrollView
                  ? SingleChildScrollView(
                      controller: widget.scrollController,
                      physics: const BouncingScrollPhysics(),
                      child: OnboardingContent(page: widget.page),
                    )
                  : OnboardingContent(page: widget.page),
            ),
          ),
        ].asReversed(widget.page.reverse),
      ),
