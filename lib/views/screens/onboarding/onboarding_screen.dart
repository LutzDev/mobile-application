...
import 'package:fancai_client/views/widgets/dots_indicator.dart';
import 'package:fancai_client/models/onboarding_page.dart';
import 'package:fancai_client/views/widgets/onboarding/onboarding_button.dart';
import 'package:fancai_client/views/screens/onboarding/onboarding_page.dart';

class IntroductionScreen extends StatefulWidget {
  /// All pages of the onboarding
  final List<OnboardingPageViewModel>? pages;

  /// All pages of the onboarding, as a complete widget instead of a OnboardingPageViewModel
